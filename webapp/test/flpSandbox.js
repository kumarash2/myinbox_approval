		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#MIAmyinboxap-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"MIAmyinboxap-display": {
								"semanticObject": "MIAmyinboxap",
								"action": "display",
								"description": "My Inbox Approval",
								"title": "My Inbox Approval",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=MIA.myinboxap",
									"url": sap.ui.require.toUrl("MIA/myinboxap")
								}
							}
						}
					}
